import { Box, Button, ButtonGroup, Container, HStack, useBreakpointValue, useDisclosure, Text } from "@chakra-ui/react";
      ...
      <Box position="relative" zIndex="tooltip">
        <Container py="4" maxW={'8xl'}>
          <HStack justify="space-between">
            <Text fontSize="2xl" fontWeight="bold" color="white">Assessments.</Text>
            {isDesktop ? (
              <>

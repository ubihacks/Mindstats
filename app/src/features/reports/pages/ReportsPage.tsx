...
import {
  ...
  IconButton, Tooltip, Select, Icon,
} from '@chakra-ui/react';
import { DownloadIcon } from '@chakra-ui/icons';
import { MdFilterList, MdBarChart } from 'react-icons/md';
import { useAppDispatch, useAppSelector } from '../../../app/hooks';
import { fetchAssessmentResults } from '../reportsSlice';
...
const ReportsPage: React.FC = () => {
  ...
  const { reports: _reports, status: _status, assessmentResults, resultsStatus } = useAppSelector((s) => s.reports);
  ...
  return (
    <Box>
      ...
      <Flex justify="space-between" align="flex-start" mb={8}>
        <VStack align="start" spacing={0.5}>
          ...
          <Text color="gray.500" fontSize="sm">
            Assessment results and DISC profiles
          </Text>
        </VStack>
      </Flex>
      ...
      <HStack mb={6} spacing={3} bg="white" p={4} borderRadius="xl" border="1px solid" borderColor="gray.100">
        ...
        <Select
          placeholder="All Projects" maxW="300px" value={filterRoleId}
      ...
      <Flex justify="space-between" align="center" mb={3}>
        <HStack spacing={2}>
          ...
          <Text fontSize="sm" fontWeight="700" color="gray.700">Assessment Results</Text>
          <Badge borderRadius="full" px={2} fontSize="10px"
            bg={NAVY} color="white">{filteredResults.length}</Badge>
        </HStack>
                  ...
                  <Tbody>
                    {isResultsLoading ? (
                      ...
                      filteredResults.map((result) => {
                        ...
                        <Td>
                          <Tooltip label="Download PDF report" hasArrow>
                            <IconButton
